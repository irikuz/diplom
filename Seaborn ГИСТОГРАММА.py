...
class Graph:
    """Класс для визуализации гистограмм.
    ...
    def plot(self):
        ...
        Использует Seaborn для построения гистограммы на основе
        переданных данных и отображает график с заданными заголовком и подписями осей.
        """
        # Создаем график
        plt.figure(figsize=(15, 6))
        # Рисуем гистограмму согласно переданным переменным x и y
        sns.histplot(x=self.x_data, y=self.y_data)
        # Название графика
